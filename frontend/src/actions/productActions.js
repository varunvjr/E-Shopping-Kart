import {PRODUCT_LIST_FAIL,PRODUCT_LIST_REQUEST,PRODUCT_LIST_SUCCESS,PRODUCT_DETAILS_FAIL,PRODUCT_DETAILS_SUCCESS,PRODUCT_DETAILS_REQUEST,
    PRODUCT_UPDATE_REQUEST,PRODUCT_UPDATE_FAIL,PRODUCT_UPDATE_SUCCESS,
    PRODUCT_DELETE_FAIL,PRODUCT_DELETE_REQUEST,PRODUCT_DELETE_SUCCESS,PRODUCT_CREATE_FAIL,PRODUCT_CREATE_REQUEST,PRODUCT_CREATE_SUCCESS,
...
export const listProducts=(keyword='')=>async(dispatch)=>{
    try{
        ...
        const res=await axios.get(`http://localhost:5000/api/products?keyword=${keyword}`);
